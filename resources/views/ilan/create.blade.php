...
<body>
<form method="POST" action="{{route('ilan.store')}}">
    @csrf
    <center> 
    <input name="ilan_türü" type="text" value="naklıye"> <br>
    <input name="user_id" type="text" value="1"><br>
    <input name="ilan_basligi" type="text" value="test ılanı"><br>
    ...
    <input name="miktar" type="text" value="2 ton"><br>
